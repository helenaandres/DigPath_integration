...
def get_data(data):
    ...
    img_rho = data[[col for col in data if col.startswith('img_Rho')]]
    img_s = data[[col for col in data if col.startswith('img_S')]]
    img_v = data[[col for col in data if col.startswith('img_V')]]
